                ...
                <div class="tab-content">
                    ...
                    <div v-if="activeTab === 'info'" class="info-box">
                        ...
                        <div v-if="featureInfo">
                            <p><strong>Tên tỉnh:</strong> {{ featureInfo.ten_tinh }}</p>
                            <p><strong>Mã tỉnh:</strong> {{ featureInfo.ma_tinh }}</p>
                            <p><strong>Quốc gia:</strong> {{ featureInfo.quoc_gia }}</p>
...
const fetchTinhData = async () => {
    try {
        ...
        const response = await getTinhById(id);
